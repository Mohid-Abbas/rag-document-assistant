...
|:---------------------------:|:------------:|:--------------:|
| ![Swagger UI](./docs/swagger.png) <br> *Path: http://localhost:8000/docs* | ![n8n](./docs/n8n-workflow.png) <br> *Export your n8n workflow* | ![Chat](./docs/query-demo.png) <br> *Example query response* |
